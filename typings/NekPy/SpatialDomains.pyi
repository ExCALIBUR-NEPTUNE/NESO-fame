...
PointGeomMap = MutableMapping[int, PointGeom]
SegGeomMap = MutableMapping[int, SegGeom]
TriGeomMap = MutableMapping[int, TriGeom]
QuadGeomMap = MutableMapping[int, QuadGeom]
TetGeomMap = MutableMapping[int, TetGeom]
PrismGeomMap = MutableMapping[int, PrismGeom]
PyrGeomMap = MutableMapping[int, PyrGeom]
HexGeomMap = MutableMapping[int, HexGeom]
CurveMap = MutableMapping[int, Curve]
CompositeMap = MutableMapping[int, Composite]

class MeshGraph:
    def GetMeshDimension(self) -> int: ...
    def GetSpaceDimension(self) -> int: ...
    def SetMeshDimension(self, dim: int) -> None: ...
    def SetSpaceDimension(self, dim: int) -> None: ...
...
class MeshGraphIO:
    @classmethod
    def Read(cls, session: LibUtilities.DomainRangeShPtr, fillGraph: bool) -> Self: ...
    def Write(
...
ZoneMap = MutableMapping[int, Zone]
